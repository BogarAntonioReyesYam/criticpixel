    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      >
        ...
        <div className="mb-10 space-y-2">
          ...
          <p className="text-gray-400">Noticias, guias y analisis del mundo gaming.</p>
        </div>
        ...
        <div className="relative max-w-md mb-6">
          ...
          <input
            ...
            className="w-full bg-gamingCard border border-white/5 rounded-lg py-2.5 pl-10 pr-4 focus:outline-none focus:border-gamingOrange transition-colors text-sm"
          />
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-widest transition-all ${
                selectedCategory === cat
                  ...
                  : 'bg-gamingCard text-gray-500 hover:text-white border border-white/5 hover:border-white/10'
              }`}
            >
              {cat}
            </button>
            ...
            {filteredArticles.length > 0 ? (
              filteredArticles.map((article, i) => (
                <motion.article
                  ...
                  className="group bg-gamingCard rounded-2xl border border-white/5 hover:border-gamingOrange/30 overflow-hidden transition-all duration-300"
                >
                  <div className="flex flex-col md:flex-row">
                    <div className="md:w-72 h-48 md:h-auto relative overflow-hidden flex-shrink-0">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-gamingCard to-transparent md:hidden" />
                    </div>
                    <div className="flex-1 p-6 space-y-4">
                      ...
                      <h2 className="text-xl font-bold group-hover:text-gamingOrange transition-colors">
                        {article.title}
                      </h2>
                      ...
                      <div className="flex gap-2 pt-2">
                        {article.tags.slice(0, 3).map(tag => (
                          <span key={tag} className="text-[9px] bg-white/5 px-2 py-0.5 rounded text-gray-500 border border-white/5 uppercase font-medium">
                            {tag}
                          </span>
                        ))}
                      </div>
